...
public class ContactsController {
    ...
    public ContactDTO create(@RequestBody ContactCreateDTO contactData) {
        var contact = contactEntity(contactData); // Сначала в Entity
        contactRepository.save(contact);
        return contactDTO(contact);
    }

    private ContactDTO contactDTO(Contact contact) {
    ...
    private Contact contactEntity(ContactCreateDTO contactCreateDTO) {
